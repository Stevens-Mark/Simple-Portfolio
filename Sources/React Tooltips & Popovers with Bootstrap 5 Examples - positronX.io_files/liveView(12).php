...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=100431&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed155blkzgtxiv&vp_template=6130&subId=[SUBID_ENCODED]&cbuster=1650723883',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"100.0.4896.127","browserVersionMajor":"100","browserVersionMinor":"0","chromeVersion":"100"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":["en","fr"],"googlePSI":false},
					isFpCookie: 0,
					geo: 'FR',
					dmaCode: 0,
					dynamicSetup: [],
